...
// It's worth noting that these wrapper functions, both wrapPromise and createResource, are not unique to this particular API call. They could be used to handle almost any API call; you won't have to custom-engineer a brand-new wrapper for any given fetch